...
* * * * * php /var/www/html/docroot/bin/console mautic:segments:update 2>&1 | tee /tmp/stdout
* * * * * php /var/www/html/docroot/bin/console mautic:campaigns:update 2>&1 | tee /tmp/stdout
* * * * * php /var/www/html/docroot/bin/console mautic:campaigns:trigger 2>&1 | tee /tmp/stdout
...
crond -f -L /dev/stdout | tail -f /tmp/stdout
